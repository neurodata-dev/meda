...
#setwd(outdir4)
#genHTML(datRaw, outfile4, outdir = './', colCol = ccolEx, center = TRUE)
#system(paste("open", outfile4))

setwd(outdir5)
genHTML(datLog, outfile5, outdir = './', colCol = ccolEx, center = TRUE)
system(paste("open", outfile5))

setwd(outdir6)
genHTML(dat01e3, outfile6, outdir = './', colCol = ccolEx, center = TRUE)
