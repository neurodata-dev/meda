...
For each of `r mc` Monte Carlo iterates we sample `r N` points from a
mixture of four Gaussians with means `r mu0` and equal variances of `r sig20[1]`.
...
sf <- mclapply(1:NN, function(x) sample(sh1), mc.cores = 8)
