...
The default maxiumum tree depth is set to 5, even if BIC suggests we
continue.
...
The plot below shows 5 levels even if even if the clustering terminated
prior to reaching level 5. 
```{r meda-slcmeans}
tryCatch(pslc <- p.stackM(hmcL, ccol = colCol, centered = center, depth = 5))
print(pslc)
```
