...
type of dependence that involes not only the two variables themseleves
...
of other observations.  Outliers can have unwanted effects on data analysis
and therfore should be analyized themselves. 
...
each dimenison contributes to the dataset. 
...
The plot below shows how much variance is explianed when adding columns
